...
import Compression.RangeCoder.BitTreeDecoder;
...
public class Decoder
{
	class LenDecoder
	{
		...
		public void Init()
		{
			Compression.RangeCoder.Decoder.InitBitModels(m_Choice);
		...
		public int Decode(Compression.RangeCoder.Decoder rangeDecoder, int posState) throws IOException
		{
	...
	class LiteralDecoder
	{
		class Decoder2
		{
			...
			public void Init()
			{
				Compression.RangeCoder.Decoder.InitBitModels(m_Decoders);
			}
			
			public byte DecodeNormal(Compression.RangeCoder.Decoder rangeDecoder) throws IOException
			{
				int symbol = 1;
				do
			...
			public byte DecodeWithMatchByte(Compression.RangeCoder.Decoder rangeDecoder, byte matchByte) throws IOException
			{
				int symbol = 1;
				do
				{
	...
	Compression.RangeCoder.Decoder m_RangeDecoder = new Compression.RangeCoder.Decoder();
	...
	void Init() throws IOException
	{
		...
		Compression.RangeCoder.Decoder.InitBitModels(m_IsMatchDecoders);
		Compression.RangeCoder.Decoder.InitBitModels(m_IsRep0LongDecoders);
		Compression.RangeCoder.Decoder.InitBitModels(m_IsRepDecoders);
		Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG0Decoders);
		Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG1Decoders);
		Compression.RangeCoder.Decoder.InitBitModels(m_IsRepG2Decoders);
		Compression.RangeCoder.Decoder.InitBitModels(m_PosDecoders);
